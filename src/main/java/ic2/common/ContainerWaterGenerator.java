...
public class ContainerWaterGenerator extends ContainerIC2 {
  ...
  public ContainerWaterGenerator(EntityHuman entityhuman, TileEntityWaterGenerator tileentitywatergenerator) {
    super(entityhuman, tileentitywatergenerator);
    this.tileEntity = tileentitywatergenerator;
    this.a(new SlotCharge(tileentitywatergenerator, tileentitywatergenerator.tier, 0, 80, 17));
    this.a(new Slot(tileentitywatergenerator, 1, 80, 53));
