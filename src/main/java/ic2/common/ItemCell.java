...
public class ItemCell extends ItemIC2 {
  ...
  public ItemStack a(ItemStack itemstack, World world, EntityHuman entityhuman) {
    ...
    double d1 =
        entityhuman.lastY + (entityhuman.locY - entityhuman.lastY) * (double) f + 1.62D - (double) entityhuman.height;
    ...
    if (movingobjectposition == null) {
      ...
      if (movingobjectposition.type == EnumMovingObjectType.TILE) {
        ...
        if (world.getTypeId(i, j, k) == Block.STATIONARY_WATER.id && world.getData(i, j, k) == 0 &&
            this.storeCell(Ic2Items.waterCell.cloneItemStack(), entityhuman)) {
          world.setTypeId(i, j, k, 0);
          --itemstack.count;
          return itemstack;
        }
  
        if (world.getTypeId(i, j, k) == Block.STATIONARY_LAVA.id && world.getData(i, j, k) == 0 &&
            this.storeCell(Ic2Items.lavaCell.cloneItemStack(), entityhuman)) {
          world.setTypeId(i, j, k, 0);
          --itemstack.count;
          return itemstack;
        }
