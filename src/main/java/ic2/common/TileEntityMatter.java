...
public class TileEntityMatter extends TileEntityElecMachine implements IHasGui, ISidedInventory {
  ...
  public boolean attemptGeneration() {
    ...
    else if (this.inventory[1].doMaterialsMatch(Ic2Items.matter) &&
  ...
  public int injectEnergy(Direction direction, int i) {
    if (i > 512) {
      ...
      ExplosionIC2 explosionic2 =
          new ExplosionIC2(this.world, null, this.x, this.y, this.z, 15.0F, 0.01F, 1.5F);
    ...
    if (s.equals("state") && this.prevState != this.state) {
      switch (this.state) {
        ...
        case 1:
          if (this.audioSource == null) {
            this.audioSource = AudioManager
                .createSource(this, PositionSpec.Center, "Generators/MassFabricator/MassFabLoop.ogg", true, false,
        ...
        case 2:
          ...
          if (this.audioSourceScrap == null) {
            this.audioSourceScrap = AudioManager
                .createSource(this, PositionSpec.Center, "Generators/MassFabricator/MassFabScrapSolo.ogg", true, false,
                    AudioManager.defaultVolume);
          }
