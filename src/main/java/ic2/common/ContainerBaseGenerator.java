...
public class ContainerBaseGenerator extends ContainerIC2 {
  ...
  public ContainerBaseGenerator(EntityHuman entityhuman, TileEntityBaseGenerator tileentitybasegenerator) {
    super(entityhuman, tileentitybasegenerator);
    this.tileEntity = tileentitybasegenerator;
    this.a(new SlotCharge(tileentitybasegenerator, tileentitybasegenerator.tier, 0, 65, 17));
    this.a(new Slot(tileentitybasegenerator, 1, 65, 53));
