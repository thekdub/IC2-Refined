...
public final class Ic2Recipes {
  ...
  public static void addCraftingRecipe(ItemStack itemstack, Object[] aobj) {
    try {
      Class.forName(getPackage() + ".common.AdvRecipe")
          .getMethod("addAndRegister", ItemStack.class, Array.newInstance(Object.class, 0).getClass())
          .invoke(null, itemstack, aobj);
  ...
  public static void addShapelessCraftingRecipe(ItemStack itemstack, Object[] aobj) {
    try {
      Class.forName(getPackage() + ".common.AdvShapelessRecipe")
          .getMethod("addAndRegister", ItemStack.class, Array.newInstance(Object.class, 0).getClass())
          .invoke(null, itemstack, aobj);
    } catch (Exception var3) {
      throw new RuntimeException(var3);
  ...
  private static ItemStack getOutputFor(ItemStack itemstack, boolean flag, List list) {
    if (!$assertionsDisabled && itemstack == null) {
      ...
      } while (!((ItemStack) entry.getKey()).doMaterialsMatch(itemstack) ||
  ...
  public static void addScrapboxDrop(ItemStack itemstack, float f) {
    try {
      Class.forName(getPackage() + ".common.ItemScrapbox").getMethod("addDrop", ItemStack.class, Float.TYPE)
          .invoke(null, itemstack, f);
    } catch (Exception var3) {
      throw new RuntimeException(var3);
    }
  }
