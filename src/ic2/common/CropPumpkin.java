...
public class CropPumpkin extends CropCard {
  ...
  public ItemStack getSeeds(TECrop tecrop) {
    return tecrop.statGain <= 1 && tecrop.statGrowth <= 1 && tecrop.statResistance <= 1 ? new ItemStack(Item.PUMPKIN_SEEDS, mod_IC2.random.nextInt(3) + 1) : super.getSeeds(tecrop);
  }
