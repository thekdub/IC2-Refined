...
public class CropMelon extends CropCard {
  ...
  public ItemStack getGain(TECrop tecrop) {
    return mod_IC2.random.nextInt(3) == 0 ? new ItemStack(Block.MELON) : new ItemStack(Item.MELON, mod_IC2.random.nextInt(4) + 2);
  }

  public ItemStack getSeeds(TECrop tecrop) {
    return tecrop.statGain <= 1 && tecrop.statGrowth <= 1 && tecrop.statResistance <= 1 ? new ItemStack(Item.MELON_SEEDS, mod_IC2.random.nextInt(2) + 1) : super.getSeeds(tecrop);
  }
