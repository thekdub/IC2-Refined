...
public class AdvRecipe implements CraftingRecipe {
  ...
  public static boolean canShow(Object[] aobj, ItemStack itemstack, boolean flag) {
    return (!mod_IC2.enableSecretRecipeHiding || !flag) && !recipeContains(aobj, Ic2Items.reBattery) && (!recipeContains(aobj, Ic2Items.industrialDiamond) || itemstack.id != Item.DIAMOND.id);
  }
            ...
            for (j3 = 0; j3 < i; ++j3) {
              ...
              if (itemstack1 != null) {
                ...
                while (iterator.hasNext()) {
                  ...
                  else if (itemstack1.doMaterialsMatch(itemstack2) || itemstack2.getData() == -1 && itemstack1.id == itemstack2.id) {
                    flag = true;
                    break;
                  }
                }
