		...
		mod_IC2.addSingleTickCallback(this.world, new ITickCallback() {
			public void tickCallback(World world) {
				if (!TileEntityBlock.this.l() && world != null) {
					...
					System.out.println("[IC2] " + TileEntityBlock.this + " (" + TileEntityBlock.this.x + "," + TileEntityBlock.this.y + "," + TileEntityBlock.this.z + ") was not added, isInvalid=" + TileEntityBlock.this.l() + ", worldObj=" + world);
				}
