...
public class ItemArmorSolarHelmet extends ItemArmorUtility implements IItemTickListener {
	...
	public boolean onTick(EntityHuman entityhuman, ItemStack itemstack) {
		if (entityhuman.inventory.armor[2] != null && entityhuman.inventory.armor[2].getItem() instanceof IElectricItem && TileEntitySolarGenerator.isSunVisible(entityhuman.world, (int) entityhuman.locX, (int) entityhuman.locY + 1, (int) entityhuman.locZ)) {
