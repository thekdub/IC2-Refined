...
public abstract class TileEntityElectricBlock extends TileEntityMachine implements IEnergySink, IEnergySource, IHasGui, ISidedInventory, INetworkClientTileEntityEventListener {
  ...
  public void q_() {
    ...
    if (this.energy >= this.output && (this.redstoneMode != 4 || !this.world.isBlockPowered(this.x, this.y, this.z)) && (this.redstoneMode != 5 || !this.world.isBlockPowered(this.x, this.y, this.z) || this.energy >= this.maxStorage)) {
