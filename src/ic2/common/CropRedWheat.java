...
public class CropRedWheat extends CropCard {
	...
	public ItemStack getGain(TECrop tecrop) {
		return !tecrop.world.isBlockPowered(tecrop.x, tecrop.y, tecrop.z) && !tecrop.world.random.nextBoolean() ? new ItemStack(Item.WHEAT, 1) : new ItemStack(Item.REDSTONE, 1);
	}
