...
public final class StackUtil {
  ...
  public static boolean isStackEqual(ItemStack itemstack, ItemStack itemstack1) {
    return itemstack != null && itemstack1 != null && itemstack.id == itemstack1.id && (Platform.unknown1(itemstack.getItem()) || itemstack.getItem().g() || itemstack.getData() == itemstack1.getData());
  }
}
